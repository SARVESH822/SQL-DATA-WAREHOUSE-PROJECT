...
PostgreSQL Functions Used:
    ...
    - DATE_PART(), AGE(): Date difference calculations
===============================================================================
*/
...
/* Group customers into three segments based on their spending behavior:
   ...
   And find the total number of customers in each segment
*/
-------------------------------------------------------------------------------
...
WITH customer_spending AS (
    SELECT
        ...
        -- Lifespan in months (PostgreSQL equivalent of DATEDIFF(month))
        (
